...
def process(text, pipeline, keep_pos=True, keep_punct=False):
...
udpipe_model = Model.load('udpipe_syntagrus.model')
process_pipeline = Pipeline(
    udpipe_model, "tokenize", Pipeline.DEFAULT, Pipeline.DEFAULT, "conllu"
)
preprocess = partial(process, pipeline=process_pipeline, keep_pos=False, keep_punct=True)
